...
(() => {
	...
	function useFriendStatus(friendID) {
		...
		// Второй параметр - необязательный, функция
		// форматирования возвращаемого значения;
		// вызывается только при проверке хука
		useDebugValue(isOnline ? `В сети` : `Не в сети`, status => `Статус друга: ${status}`);
